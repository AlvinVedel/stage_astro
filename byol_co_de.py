...
model.load_weights("./checkpoints_co_de/byol_co_de_epoch_10.weights.h5")
...
checkpoint_dir = 'checkpoints_co_de/'
os.makedirs(checkpoint_dir, exist_ok=True)

# Callback pour sauvegarder les poids toutes les 50 époques
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath=os.path.join(checkpoint_dir, 'byol_co_de_100epoch_{epoch:02d}.weights.h5'),
...
model.save_weights("byol_co_de100.weights.h5")
print("SAVE ENDED")
