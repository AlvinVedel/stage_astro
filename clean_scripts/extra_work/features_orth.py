...
from models.contrastiv_model import simCLR1
import os
import gc
...
### INVESTIGATION SUR L ORTHOGONALITE DES FEATURES DANS LE RESEAU PRE ENTRAINE EN SSL
...
model = simCLR1(backbone(), mlp(1024))
