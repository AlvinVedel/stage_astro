...
# métriques astrophysiques pour estimer la qualité de la prédiction du redshift
# BIAS : moyenne des écarts
# Sigma MAD : deviance aboslue des prédictions
# Outlier Fraction : fraction des écart absolus supérieur à un seuil
