...
from models.contrastiv_model import simCLR, simCLRcolor1
from models.deep_models import basic_backbone, projection_mlp, color_mlp, segmentor, deconvolutor, astro_head, astro_model, classif_mlp, AstroFinetune
import os 
...
CENSE PRENDRE UN MODELE SSL EN ENTRE ET LE FINETUNE SUR UNE QUANTITE DE DONNEES PROGRESSIVEMENT CROISSANTE

-> problèmes de mémoire en pratique avec allocations jean zay
