...
from models.deep_models import AstroFinetune, noregu_projection_mlp, astro_head, color_mlp
from contrastiv_model import simCLRcolor1, simCLR1
from sklearn.manifold import TSNE
import matplotlib.pyplot as plt
from utils.schedulers import AlternateTreyerScheduler
import gc


### COMPARAISON DES FEATURES OBTENUES PAR DIFFERENTES METHODES
#1 FEATURES D'INITIALISATION RANDOM
#2 FEATURES APRES ENTRAINEMENT SUPERVISE
#3 FEATURES APRES SSL
#4 FEATURES APRES FINETUNE SSL
#5 FEATURES APRES FINETUNE SSL VIA Improving Fine-tuning of Self-supervised Models with Contrastive Initialization   https://arxiv.org/abs/2208.00238
...
del finetune_et_contrast_all_ssl_features
gc.collect()
