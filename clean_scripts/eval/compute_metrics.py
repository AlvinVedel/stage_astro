...
from models.deep_models import basic_backbone, astro_head, astro_model, AstroModel, adv_network, AstroFinetune
import os
...
####
# POUR UN MODEL DONNE, PRODUIT L INFERENCE SUR LES BASE UD ET D NON UTILISEES POUR LE FINETUNE, CALCULE LES METRIQUES ET LES SAUVEGARDE (PLOTS OPTIONNELS)
####
