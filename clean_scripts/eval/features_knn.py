...
from models.contrastiv_model import simCLRcolor1
from models.deep_models import basic_backbone, projection_mlp, color_mlp, classif_mlp
...
POUR UN MODELE DONNE, EFFECTUE UN KNN SUR LES FEATURES PROJETEES EN PETITE DIMENSION 
(PAR TSNE OU ACP) ET PRODUIT PLOT D INFERENCE
