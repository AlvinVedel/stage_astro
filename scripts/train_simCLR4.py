...
from deep_models import basic_backbone, projection_mlp, color_mlp, treyer_backbone, segmentor, deconvolutor, classif_mlp, noregu_projection_mlp, comhe_backbone, comhe_projection_head
...
iter_suffixe="_comhe_test1_thom3_L5"
...
model = simCLRcolor1(comhe_backbone(), comhe_projection_head(1024), color_head=color_mlp(1024))
