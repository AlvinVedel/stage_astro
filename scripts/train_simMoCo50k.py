...
if load_model :
    backbone.load_weights("../model_save/backbone_simMoco_50k_14iter.weights.h5")
    head.load_weights("../model_save/head_simMoco_50k_14iter.weights.h5")
    color_head.load_weights("../model_save/color_head_50k_14.weights.h5")
...
while True :   ## on attend fin du job
    ...
    backbone.save_weights("/lustre/fswork/projects/rech/dnz/ull82ct/astro/model_save/backbone_simMoco_50k_"+str(iter_)+"iter.weights.h5")
    head.save_weights("/lustre/fswork/projects/rech/dnz/ull82ct/astro/model_save/head_simMoco_50k_"+str(iter_)+"iter.weights.h5")
    color_head.save_weights("/lustre/fswork/projects/rech/dnz/ull82ct/astro/model_save/color_head_50k_"+str(iter_)+".weights.h5")
