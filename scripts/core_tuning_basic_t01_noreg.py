...
model = simCLRcolor1(basic_backbone(full_bn=False), noregu_projection_mlp(1024, False), color_mlp(1024))
...
load_w_path = "model_save/checkpoints_new_simCLR/v2__300_ColorHead_Regularized_noBN.weights.h5"
save_w_path = "model_save/simCLR_finetune_comparaison/basic_color_t01_noreg"
