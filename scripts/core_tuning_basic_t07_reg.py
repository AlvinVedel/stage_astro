...
load_w_path = "model_save/checkpoints_new_simCLR/simCLR_UD_D_norm300_ColorHead_Regularized.weights.h5"
save_w_path = "model_save/simCLR_finetune_comparaison/basic_color_t07_reg"
...
for condition in ["coretuning"] :
    for base in ["base2", "base3"] :
        ...
        if condition == "finecon"  and base != "base2" and base!="base1":
