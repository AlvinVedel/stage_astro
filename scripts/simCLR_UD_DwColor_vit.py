...
class LearningRateScheduler(tf.keras.callbacks.Callback):
    def __init__(self, initial_lr, target_lr, max_epochs, decay_factor=1.0):
        super().__init__()
        self.initial_lr = initial_lr
        self.target_lr = target_lr
        self.max_epochs = max_epochs
        self.decay_factor = decay_factor
        self.epoch_counter = 0  # Compteur pour le nombre d'époques
    ...
    def on_epoch_begin(self, epoch, logs=None):
        ...
        current_lr = self.cosine_lr_schedule()
...
lr = LearningRateScheduler(1e-3, 1e-6, 1000)
