...
model = simCLRcolor1(ViT_backbone(embed_dim=1024, num_blocks=4, num_heads=8, patch_size=8, gp='none', mlp_ratio=2.0), projection_mlp(1024), color_mlp(1024))
...
load_w_path = "model_save/checkpoints_new_simCLR/simCLR_UD_D_norm300ViT_petit_model_v2.weights.h5"
save_w_path = "model_save/simCLR_finetune_comparaison/vit_t07_reg"
...
for condition in ["coretuning"] :
    for base in ["base3"] :
        ...
        if condition == "fine" and base!="base1" and base!="base2":
