...
model = simCLRcolor1(ViT_backbone(embed_dim=1024, num_blocks=4, num_heads=8, patch_size=8, gp='none', mlp_ratio=2.0), noregu_projection_mlp(1024, False), color_mlp(1024))
...
load_w_path = "model_save/checkpoints_new_simCLR/v2__300ViT_petit_model_v2.weights.h5"
...
for base in ["base3"] :
    ...
    n_epochs = 100
    for condition in ["coretuning"] : #["coretuning", "finecon"] :
    #for base in ["base3"] :
