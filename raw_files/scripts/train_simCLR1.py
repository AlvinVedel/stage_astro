...
iter_suffixe="_ColorHead_RegularizedTrue_noBN"
...
model = simCLRcolor1(basic_backbone(full_bn=False, all_bn=False), projection_mlp(1024, False), color_mlp(1024), temp=0.1)
...
"""
if load_model :
    model.load_weights("../model_save/checkpoints_new_simCLR/v2__200_ColorHead_RegularizedTrue_noBN.weights.h5")
