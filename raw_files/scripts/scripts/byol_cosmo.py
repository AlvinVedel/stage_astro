...
data_gen = ByolGenerator(folder_path="/lustre/fswork/projects/rech/kof/uve94ap/CUBES_HSC/PHOT/COSMOS", folder_extension='_D.npz', batch_size=256)
...
model.load_weights("./checkpoints/byol_cosmo_epoch_10.weights.h5")
...
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath=os.path.join(checkpoint_dir, 'byol_cosmo_100epoch_{epoch:02d}.weights.h5'),
...
model.save_weights("byol_cosmo100.weights.h5")
print("SAVE ENDED")
