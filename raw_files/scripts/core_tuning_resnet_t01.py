...
load_w_path = "model_save/checkpoints_new_simCLR/v2__300_ColorHead_NotRegularized_resnet50.weights.h5"
save_w_path = "model_save/simCLR_finetune_comparaison/resnet50_color_t01"
...
for condition in ["coretuning"] :
    for base in ["base2", "base3"] :
        ...
        if condition == "finecon" and base != "base1" and base != "base2":
