...
model = simCLRcolor1(ViT_backbone(embed_dim=1024, num_blocks=4, num_heads=8, patch_size=8, gp='none', mlp_ratio=2.0), projection_mlp(1024, False), color_mlp(1024))
...
load_w_path = "model_save/checkpoints_new_simCLR/v2__300ViT_petit_model_v2_regularized.weights.h5"
