...
if load_model :
    backbone.load_weights("../model_save/backbone_simMoco_20k_16iter.weights.h5")
    head.load_weights("../model_save/head_simMoco_20k_16.weights.h5")
    color_head.load_weights("../model_save/color_head_20k_16.weights.h5")
...
while True :   ## on attend fin du job
    ...
    backbone.save_weights("/lustre/fswork/projects/rech/dnz/ull82ct/astro/model_save/backbone_simMoco_20k_"+str(iter_)+"iter.weights.h5")
    head.save_weights("/lustre/fswork/projects/rech/dnz/ull82ct/astro/model_save/head_simMoco_20k_"+str(iter_)+".weights.h5")
    color_head.save_weights("/lustre/fswork/projects/rech/dnz/ull82ct/astro/model_save/color_head_20k_"+str(iter_)+".weights.h5")
