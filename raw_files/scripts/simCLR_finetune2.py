...
for base in ["base1", "base2", "base3"] :
    ...
    history = model1.fit(data_gen, epochs=n_epochs, callbacks=[TreyerScheduler()])
    model1.save_weights(base_path+save_w_path+"_ALL_base="+base+"_model="+model_name+"_HeadPre0_clip3.weights.h5")
    ...
    history = model1.fit(data_gen, epochs=n_epochs, callbacks=[TreyerScheduler()])
    model1.save_weights(base_path+save_w_path+"_ALL_base="+base+"_model="+model_name+"_HeadPre10_clip3.weights.h5")
